...
public class TemplateFragment extends BaseFragment {
    ...
    private static TemplateFragment INSTANCE = null;
    ...
    // 선택 선언 3_1 (ViewModel)
    TemplateFragemntViewModel templateFragmentVM;
    public TemplateFragemntViewModel getTemplateVM() {
        return templateFragmentVM;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        templateFragmentVM = ViewModelProviders.of(this).get(TemplateFragemntViewModel.class);
    ...
    public View onDataBinding(LayoutInflater inflater, ViewGroup container) {
        ...
        binding.setTemplateFragmentView(this);
        binding.setTemplateFragmentVM(templateFragmentVM);
